...
class User extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['firstName','lastName','email','phone_number', 'password', 'two_factor_secret','two_factor_recovery_codes','two_factor_confirmed_at','act','gender','typeId'];
